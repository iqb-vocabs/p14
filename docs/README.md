...
ID of profile: [https://raw.githubusercontent.com/iqb-vocabs/p14/master/unit.json](https://raw.githubusercontent.com/iqb-vocabs/p14/master/unit.json)
...
| Kompetenzbereich | [Vokabular](https://w3id.org/iqb/v13/k1/) | url: 'https://w3id.org/iqb/v13/k1/', Einmalauswahl, Zeige nur erste Ebene, Dialogbox | w8 |
| Aufgabenzeit | Zahl | Kommastellen: 0, Mindestwert: 0, Maximalwert: kein, als Sekunden | iqb_time_unit |
| Quellenangaben | Text | Mehrzeilig, Sprache(n): de   | iqb_copyright |
| Textsorte | [Vokabular](https://w3id.org/iqb/v28/ts/) | url: 'https://w3id.org/iqb/v28/ts/', Einmalauswahl, Dialogbox | k8 |
...
ID of profile: [https://raw.githubusercontent.com/iqb-vocabs/p14/master/item.json](https://raw.githubusercontent.com/iqb-vocabs/p14/master/item.json)
...
| Anforderungsbereich | [Vokabular](https://w3id.org/iqb/v13/a1/) | url: 'https://w3id.org/iqb/v13/a1/', Einmalauswahl, Dialogbox, Nummerierung unterdrückt | s4 |
| Bildungsstandard primär | [Vokabular](https://w3id.org/iqb/v13/k1/) | url: 'https://w3id.org/iqb/v13/k1/', Einmalauswahl, Dialogbox | s5 |
| Bildungsstandards sekundär | [Vokabular](https://w3id.org/iqb/v13/k1/) | url: 'https://w3id.org/iqb/v13/k1/', Mehrfachauswahl, Dialogbox | s6 |
